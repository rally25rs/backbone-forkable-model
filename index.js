(function() {
  ...
  } else if(window._ && window.Backbone) {
    // global
    window.Backbone.ForkableModel = factory(window.Backbone, window._);
  } else {
    console.error('Unable to determine module system. Requires CJS or have global Backbone and _ (underscore) defined.');
  }
